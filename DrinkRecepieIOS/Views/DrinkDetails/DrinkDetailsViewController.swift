...
//    private let drinkTypeLabel = UILabel() // Added label for drink type
...
//
//        drinkTypeLabel.font = .systemFont(ofSize: 18) // Configure font size and style
//        drinkTypeLabel.textColor = .gray // Optional: Set text color
//        view.addSubview(drinkTypeLabel) // Add the drink type label to the view hierarchy
//
